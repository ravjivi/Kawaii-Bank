...
public class Main
{
    ...
    public static void closeAccount() {
        ...
        if (Accounts.returnIndex(name) != 0) {
            if (verifyAccount(name)) {
                System.out.println("This account is now closed");
                accountsList.remove(Accounts.returnIndex(name));
            } else {
                System.out.println("This is not the right address, try again");
                closeAccount();
            }
        } else {
            System.out.println("We do not hold a account with the name "+name+", perhaps you mispelled the name");
            closeAccount();
        }
